        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{route("register.post")}}">
                    ...
                    {{-- Password --}}
                    <div class="form-group mb-3">
                        <input type="password" placeholder="Jelszó" id="password" class="form-control" name="password"
                            required>
                    ...
                    {{-- Password Again --}}
                    <div class="form-group mb-3">
                        <input type="password" placeholder="Jelszó mégegyszer" id="password_again" class="form-control"
                            name="password_again" required>
