...
{{--Showing and updating the profile data--}}
            ...
            <div class="card-body">
                ...
                @endif
                        ...
                        <div class="form-group mb-3">
                            <input type="text" placeholder="Vezetéknév" id="name" class="form-control" name="name"
                                value="{{$user->name}}" {{$editing ? 'required autofocus' : 'disabled'}}>
                            @if($errors->has('name'))
                    ...
                    {{-- Delete button --}}
                    <div class="d-grid mx-auto">
                        <a class="btn btn-danger" href="#" onclick="return confirmDelete('delete-form');">Törlés</a>
